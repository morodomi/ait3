...
### Migration Commands
```bash
ait3 migrate local github     # Migrate all tickets to GitHub
ait3 migrate github local     # Migrate all tickets to local
ait3 migrate local github --tickets "1,3-5"  # Migrate specific tickets
```
...
- Supports both local and GitHub Issues backends
